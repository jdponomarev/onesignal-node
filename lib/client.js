...
var basicRequest = function (url, apiKey, method, body, callback) {
  ...
  return new Promise(function (resolve, reject) {
    request(options, function (err, httpResponse, data) {
      if (err) {
        return callback ? callback(err, httpResponse, data) : reject(err);
      }
      return callback ? callback(err, httpResponse, data) : resolve({ httpResponse: httpResponse, data: data });
    });
  });
};
